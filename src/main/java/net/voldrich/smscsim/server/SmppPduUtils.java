...
public class SmppPduUtils {
  ...
  public static DeliverSm createDeliveryReceipt(
      DeliveryReceiptRecord deliveryReceiptRecord, int sequenceNumber) throws Exception {
  ...
  public static DeliverSm createDeliverSm(
      Address sourceAddress, Address destinationAddress, int sequenceNumber)
   ...
   */
  public static void setSegmentUdh00AndMessage(
      DeliverSm pdu, int msgRefNum, int segmentNum, int totalSegmentCount, String shortMessage)
      throws SmppInvalidArgumentException {
  ...
  public static void setSegmentUdh08AndMessage(
      DeliverSm pdu, int msgRefNum, int segmentNum, int totalSegmentCount, String shortMessage)
      throws SmppInvalidArgumentException {
    // add UDHI bit to ESM class
    byte esmClass = 0;
  ...
  public static void setSegmentOptionalParams(
      DeliverSm pdu, int msgRefNum, int segmentNum, int totalSegmentCount) {
    pdu.addOptionalParameter(
        new Tlv(SmppConstants.TAG_SAR_MSG_REF_NUM, intToUnsignedShort(msgRefNum)));
    pdu.addOptionalParameter(
        new Tlv(SmppConstants.TAG_SAR_SEGMENT_SEQNUM, intToUnsignedByte(segmentNum)));
    pdu.addOptionalParameter(
        new Tlv(SmppConstants.TAG_SAR_TOTAL_SEGMENTS, intToUnsignedByte(totalSegmentCount)));
  }
