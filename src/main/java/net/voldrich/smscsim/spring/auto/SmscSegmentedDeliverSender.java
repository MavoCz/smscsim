...
public class SmscSegmentedDeliverSender extends BaseSender {
  ...
  public void sendSegmentedDeliverMsg(int numberOfSegments) throws Exception {
    ...
    for (int i = 1; i <= numberOfSegments; i++) {
      ...
      DeliverSm pdu =
          SmppPduUtils.createDeliverSm(
              sourceAddress, destinationAddress, getSessionManager().getNextSequenceNumber());
  ...
  @ManagedOperation
  public void sendSegmentedDeliverMsgRandomized(int numberOfMessages, int numberOfSegments)
      throws Exception {
